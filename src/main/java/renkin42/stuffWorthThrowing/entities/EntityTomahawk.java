...
public class EntityTomahawk extends EntityThrowable {
    ...
    private int damage;
    private ItemStack tomahawkItemstack;
    ...
    public EntityTomahawk(World par1World, EntityLivingBase par2EntityLivingBase, byte strength, String tomahawkName, int damage, Item tomahawkItem) {
        super(par1World, par2EntityLivingBase);
        this.strength = strength;
        this.tomahawkName = tomahawkName;
        this.damage = damage;
        this.tomahawkItemstack = new ItemStack(tomahawkItem);
    }
    ...
    public ItemStack getTomahawkItem() {
        return this.tomahawkItemstack;
    }
